    ...
    const [selectedFlavor, setSelectedFlavor] = useState<string>('mint');
      ...
      return (
        <div className=' w-[1200px] h-[1117px]'>
             <div className={`min-h-screen bg-gradient-to-br from-[#9C5C3F]  to-[#E0BDB0] transition-all duration-1000 ease-in-out relative overflow-hidden`}>
          ...
          <img 
            src="/4ee5cb5d136d72650c8322c347186abb14c8e72f.png"
            alt="Decorative Image"
