...
function Blue() {
      ...
      return (
        <div className=' w-[1200px] h-[1117px]'>
            <div className={`min-h-screen bg-gradient-to-br from-[#236CDA]  to-[#47C4F6] transition-all duration-1000 ease-in-out relative overflow-hidden`}>
          ...
          <img 
            src="/f91f777b3a3fb621041412682efd35e65f6681fe.png"
            alt="Decorative Image"
